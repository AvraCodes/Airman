export function AuditTimeline({ logs }: { logs: any[] }) {
  return (
    <div className="space-y-3 font-sans">
      {logs.map((log) => (
        <div key={log.id} className="rounded-xl border border-slate-850 bg-slate-900/10 p-3.5 border-l-2 border-l-indigo-500/40 hover:border-l-indigo-500 transition-all duration-200">
