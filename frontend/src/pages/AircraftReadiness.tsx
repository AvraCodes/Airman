  ...
  return (
    <section className="space-y-6 font-sans">
            ...
            <div key={a.id} className="app-card border-slate-800/40 p-5 flex flex-col justify-between space-y-4">
              <div>
                <div className="flex items-center justify-between border-b border-slate-850/60 pb-3">
                  <div>
                    <span className="text-[10px] font-bold text-cyan-400 uppercase tracking-wider">{a.aircraft_type}</span>
                ...
                {!!open.length && (
                  <div className="rounded-xl border border-rose-500/20 bg-rose-500/5 p-3 flex items-center justify-between">
                    <span className="text-[10px] font-bold text-rose-400 uppercase tracking-wide flex items-center gap-1.5">
                      ...
                      Grounding: {open.length} active defect{open.length > 1 ? "s" : ""}
                    </span>
      ...
      <div className="app-card border-slate-800/40 p-6 mt-6">
        <h3 className="text-xs font-bold uppercase tracking-wider text-slate-200 mb-4 flex items-center gap-2 border-b border-slate-855 pb-3">
          ...
          <span>OPEN DEFECTS REGISTER</span>
        </h3>
